...
class Product(models.Model):
    ...
    measurement = models.ManyToManyField(ProductMeasurement, related_name='products', blank=True)
...
class Cart(models.Model):
    user = models.ForeignKey(Users,on_delete=models.CASCADE)
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    measurement = models.ForeignKey(ProductMeasurement, on_delete=models.CASCADE, blank=True)
