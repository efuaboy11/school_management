...
SECRET_KEY = 'django-insecure-11*&!$q2guvv22(ca6kegyym7npii(w78_yb^$x52pbe%zmvsn'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Change to 'IsAuthenticated' for authentication
