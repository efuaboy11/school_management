                ...
                Card(
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 10),
                        child: Text('Note: Once your payment is complete, return to this page and upload your payment receipt in the Finalize Payment section.', style: TextStyle(color: customColors.lightText, fontSize: 15), textAlign: TextAlign.center,),
                      ),
