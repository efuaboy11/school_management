                  ...
                  <div className="site-boxes position-relative border-radius-10px recent-assignment-submission-box p-4">
                    <div>
                      <div className="d-flex justify-content-between pb-4">
                        <p>Recent Products</p>
                        <Link href='/store-keeper/subject' className='light-link'>View all</Link>
                      </div>
                          ...
                          <table className='overflow-auto'>
                            <thead>
                              <tr className='sm-text'>
                                ...
                                <th className="">discount_price</th> 
                                <th>Rating</th>                   
                              </tr>
                            </thead>
                            ...
                            <tbody>
                              {recentProduct.map((data) =>(
                                <tr key={data.id}>
                                  ...
                                  <td>{formatCurrency(data.discount_price || '')}</td>
                                  <td>{data.rating}</td>
                                </tr>
                              ))}
                    ...
                    <div>
                      ...
                      {recentStaffNotification.length > 0 ? (
                        <div>
                          ...
                          <div>
                            <Link href='/store-keeper/staff-notification' className='site-btn width-100 Link'>View All</Link>
                          </div>
                        </div>
                ...
                <div className="site-boxes border-radius-10px p-3">
                  <div className="row g-3">
                    ...
                    <div className='col-md-3'>
                      <div className="d-flex align-items-center height-100">
                        <Link href='/store-keeper/contact-us' className="site-inverse-btn px-4 py-2 Link">Get Support Now</Link>
                      </div>
