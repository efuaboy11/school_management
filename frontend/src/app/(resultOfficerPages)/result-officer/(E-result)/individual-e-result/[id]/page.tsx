...
const IndividualEResult =  ({ params }: { params: Promise<any> }) => {
  ...
  const onSubmit = (data: any, e:any) => {
    if(studentClass && termValue && sessionValue){
      EditDetails(e)
    }else{
      showAlert()
      setIsSuccess(false)
  ...
  const deleteUserFunction = async () => {
    ...
    try{
      ...
      if (response.ok) {
        ...
        router.push('/result-officer/e-result')
        setDeleteModal(false)
        showAlert()
        setIsSuccess(true)
                      ...
                      <div className={`site-modal-content scroll-bar  ${animateModal ? 'show-modal' : 'hide-modal'}`}>
                       <div>
                          <div className="d-flex justify-content-between pb-2">
                            <p className='font-size-20px '>Edit Result</p>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                              <div className="row g-3">
                                ...
                                <div className="col-md-6">
                                  ...
                                  <select   className={`site-input`}   value={sessionValue}  onChange={(e) => setSessionValue(e.target.value)}>
                                    <option value="">Select</option>
