...
const TermPage = () => {
  ...
  const deleteFunction = async () => {
    ...
    try {
      const response = await fetch('http://school.amanilightequity.com/api/delete-multiple-term/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${authTokens?.access}`,
      ...
      <div className="container-xl pt-4">
        <div className="d-md-flex justify-content-between">
          ...
          <div className='d-flex mb-4'>
            <Link href='/academic-officer/term/add' className="site-btn px-3 Link"><i className="ri-send-plane-fill pe-2"></i> Add Term</Link>
          </div>
        </div>
