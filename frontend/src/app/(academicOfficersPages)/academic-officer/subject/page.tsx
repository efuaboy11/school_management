      ...
      <div className="container-xl">
        <div className="d-flex justify-content-between">
          ...
          <div className='d-flex mb-4'>
           <Link href='/academic-officer/subject/add' className="site-btn px-3 Link"><i className="ri-send-plane-fill pe-2"></i> Add subject</Link>
          </div>
        </div>
                            ...
                            {subjects.map((data:any) => (    
                                <div className="col-lg-3  col-md-6" key={data.id}>
                                  <div className="site-boxes border-radius-10px p-3">
                                    <div className="d-flex justify-content-between">
                                      <div>
                                        <Link href={`/academic-officer/subject/individual/${data.id}`} className="Link site-border box-50px d-flex  align-center justify-content-center border-radius-5px cursor-pointer">
