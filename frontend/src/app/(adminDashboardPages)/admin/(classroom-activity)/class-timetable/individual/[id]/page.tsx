  ...
  const deleteUserFunction = async () => {
    ...
    try{
      ...
      if (response.ok) {
        ...
        router.push('/admin/class-timetable')
        setDeleteModal(false)
        showAlert()
        setIsSuccess(true)
        setMessage('Class Timetable  deleted')
      } else {
                    ...
                    <div className="site-boxes border-radius-10px">
                      ...
                      <div className='light-text p-3'>
                        ...
                        <div className="pb-3 d-sm-flex justify-content-between">
                          ...
                          <p>{formateDateTime(details.created_at)}</p>
                        </div>     


                        <div className="site-border border-radius-10px py-3">
                          <div className="border-bottom1 p-3">
                            <p className='text-center'>Timetable File</p>
                          </div>

                          {details.class_timetable ? (
                            <div className="site-light-boxes px-3 py-4 m-3 cursor-pointer" onClick={() => handleDownload(details.class_timetable, `${details.student_class_name.name}__timetable.pdf`)}>
...
export default IndivivdualClassTimeTable