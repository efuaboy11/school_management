...
const IndivivdualStaff = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const EditSchoolInformation = async(e:any) =>{
    ...
    formData.append('employment_type', emplomentStatus)
                          ...
                          <form onSubmit={handleSubmitSchoolInformation(onSchoolInformationSubmit)}>
                            <div className="row g-3">
                              ...
                              <div className="col-md-12">
                                ...
                                <input type="text"  className={`site-input ${errorsSchoolInformation.yearsOfExperience ? 'error-input' : ''}`} {...registerSchoolInformation('yearsOfExperience', {required: true})}  value={yearsOfExperience}  onChange={(e) => setYearsOfExperience(e.target.value)} placeholder='Admission Number' />
                              </div>
