...
const PayBills = ({ params }: { params: Promise<any> }) => {
  ...
  const [billID, paymentMethodID] = param.params || [];
  ...
  const handleCancel = () =>{
    ...
    const timer = setTimeout(() => {
      router.push('/student/bills-payment/make-payment/step-1/')
    }, 5000);
  ...
  useEffect(() => {
    ...
    IndividualPaymentMethodFunction()
    IndividualBankAccountFunction()
    IndividualBillFunction()
  }, [])
  ...
  return (
    <div>
      ...
      {(studentLoader || billsLoading === null || loading) ? (
        <div>
        ...
        <div className="container-lg  pt-2 mb-5 pb-4">
          <div className='pb-4 '>
            <Link href='/student/bills-payment/make-payment/step-1' className='site-link'><i className="ri-arrow-left-line me-2"></i>Previous page</Link>
          </div>
