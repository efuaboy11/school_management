...
const CheckResultPage = () => {
  ...
  const CheckResult = async (e: any) => {
    ...
    try {
      const response = await fetch(`http://127.0.0.1:8000/api/check-result/`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        router.push(`/student/check-result/${data.id}`);
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="row g-3">
                      <div className="col-12">
                        ...
                        />
                        <p className="light-text pt-2 italic-text sm-text">Select the class result you want to see</p>
                      </div>
                      ...
                      <div className="col-12">
                        ...
                        <p className="light-text pt-2 italic-text sm-text">Select the term result you want to see</p>  
                      ...
                      <div className="col-12">
                        ...
                        <p className="light-text pt-2 italic-text sm-text">Select the session result you want to see</p>
                        {errors.session && <p className="error-text">This field is required</p>}
                      </div>

                      <div className="col-12">
                        <label htmlFor="pin" className="form-label">Scratch card pin <span className="text-danger">*</span></label>
                        <input type="text" className={`site-input ${errors.pin ? 'error-input' : ''}`} {...register('pin', {required: true})}  placeholder='pin' value={pin}  onChange={(e) => setPin(e.target.value)}/>
                        <p className="light-text sm-text italic-text pt-2">Enter scratch card pin  given by your school </p>
                        {errors.pin && <p className="error-text">This field is required</p>}
                      </div>
                    </div>
