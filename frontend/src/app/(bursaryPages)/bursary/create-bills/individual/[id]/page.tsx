  ...
  const deleteUserFunction = async () => {
    ...
    try{
      ...
      if (response.ok) {
        ...
        router.push('/bursary/create-bills')
        setDeleteModal(false)
        showAlert()
        setIsSuccess(true)
        setMessage('Bills  deleted')
      } else {
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                              <div className="row g-3">
                                <div className="col-md-6">
                                  ...
                                  <input type="text" className={`site-input ${errors.billName ? 'error-input' : ''}`} {...register('billName', {required: true})}  placeholder='Bill Name' value={billName}  onChange={(e) => setBillName(e.target.value)}/>
...
export default IndivivdualBill