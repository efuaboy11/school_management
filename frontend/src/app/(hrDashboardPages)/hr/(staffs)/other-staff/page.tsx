...
const OtherStaff = () => {
  ...
  const handleSelectAll = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      const allIDs = otherStaffData.map((data) => data.id);
  ...
  // const otherStaffData = [...Array(100).keys()];
  const startIndex = (page - 1) * itemsPerPage;
  const currentItems = otherStaffData.slice(startIndex, startIndex + itemsPerPage);
  ...
  const deleteFunction = async () =>{
    ...
    try{
      ...
      if(response.ok){
        ...
        setOtherStaffData(otherStaffData.filter(dat => dat.id !== selectedIDs))
        setShowDeleteModal(false)
        setSelectedIDs([])
      ...
      <div className="container-xl pt-4">
        <div className="d-md-flex justify-content-between">
          ...
          <div className='d-flex mb-4'>
            <Link href='/hr/staffs/add' className="site-btn px-3 Link"><i className="ri-user-add-line pe-2"></i> Add  other staff</Link>
          </div>
        </div>
        ...
        <div className="d-flex justify-content-end">
          ...
          <div>
            <div className="d-flex align-items-center">
              <input type="text" className="f site-search-input" placeholder="Search" value={otherStaffSearch} onChange={(e) => setOtherStaffSearch(e.target.value)}/>
        ...
        <div>
          {otherStaffLoader ? (
            ...
            <div >
                  ...
                  <div className="col-12">
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <label className="custom-checkbox cursor-pointer me-3">
                        <input
                          type="checkbox"
                          checked={selectedIDs.length === otherStaffData.length && otherStaffData.length > 0}
                ...
                <div className="col-12 ">
                  <div className='site-boxes text-center pb-5 d-flex justify-content-center align-items-center  mt-5 pt-5'>
                    <div>
                      ...
                      <p className='light-text md-text'>No other staff available</p>
                      <p className="light-text">There is no other staff current right now. Check again later</p>
                    </div>
              ...
              {otherStaffData.length > 10 && (
                <div className="col-12 mb-4">
                  <Stack spacing={2} alignItems="center">
                    <Pagination
                      count={Math.ceil(otherStaffData.length / itemsPerPage)}
                      page={page}
