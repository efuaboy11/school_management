...
const AllStudents = () => {
  ...
  const deleteFunction = async () =>{
    ...
    try{
      let response = await fetch('http://school.amanilightequity.com/api/delete-multiple-students/', {
        method: 'POST',
        headers: {
      ...
      <div className="container-xl">
        <div className="d-md-flex justify-content-between">
          ...
          <div className='d-flex mb-4'>
            <Link href='/hr/add-student' className="site-btn px-3 Link"><i className="ri-send-plane-fill pe-2"></i> Add student</Link>
          </div>
        </div>
                  ...
                  <div className="col-lg-4 col-md-6" key={data.id}>
                    <div className="site-boxes border-radius-10px p-3">
                      ...
                      <div className="d-flex justify-content-between light-text">
                        ...
                        <Link href={`/hr/all-student/${data.id}`} className='Link light-link'>View details</Link>
                      </div>
