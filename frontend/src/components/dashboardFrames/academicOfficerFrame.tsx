        ...
        <div className={`dashboard-sidebar site-boxes border-radius-10px ${showSidebar ? 'show-sidebar': 'close-sidebar'}`}>
          ...
          <div className="pt-5 mt-4 mb-4">
            ...
            <div className="text-center pt-2">
              ...
              <p className="light-text sm-text">ACADEMIC OFFICER</p>
          ...
          <ul className='scroll-bar-y student-sidebar-height'>
            <li className="mt-3 py-3">
              <Link href='/academic-officer/home'  className='dashboard-link' onClick={OnbodyClick}>
              ...
              <div className="row">
                <div className="col-8 ps-4">
                  <div className="d-flex ">
                    <Link href='/academic-officer/subject'  className='dashboard-link' onClick={OnbodyClick}>
                      <div className="d-flex">
            ...
            <li className={`pb-2 cursor-pointer`}>
              ...
              <div>
                <ul className={`dashboard-dropdown-bg ${academicsDropdown ? "slide-in" : "slide-out"}`}>
                  <li className={`dashboard-sidebar-dropdown-link ${isActiveDashLink("/academic-officer/term") ?"active-dash-link": ""}`}>
                    <Link className='dashboard-link' href="/academic-officer/term" onClick={OnbodyClick}>
                  ...
                  <li className={`dashboard-sidebar-dropdown-link ${isActiveDashLink("/academic-officer/session") ?"active-dash-link": ""}`}>
                    <Link className='dashboard-link' href="/academic-officer/session" onClick={OnbodyClick}>
                      <div className="d-flex ps-5 py-2">
                        <p>Session</p> 
                      </div>
                    </Link>
            ...
            <li className={`pb-2 cursor-pointer`}>
              ...
              <div>
                <ul className={`dashboard-dropdown-bg ${notificationDropdown ? "slide-in" : "slide-out"}`}>
                  ...
                  <li className={`dashboard-sidebar-dropdown-link ${isActiveDashLink("/academic-officer/school-notification") ?"active-dash-link": ""}`}>
                    <Link className='dashboard-link' href="/academic-officer/school-notification" onClick={OnbodyClick}>
                      <div className="d-flex ps-5 py-2">
                  ...
                  <li className={`dashboard-sidebar-dropdown-link ${isActiveDashLink("/academic-officer/staff-notification") ?"active-dash-link": ""}`}>
                    <Link className='dashboard-link' href="/academic-officer/staff-notification" onClick={OnbodyClick}>
                      <div className="d-flex ps-5 py-2">
                  ...
                  <li className={`dashboard-sidebar-dropdown-link ${isActiveDashLink("/academic-officer/school-event") ?"active-dash-link": ""}`}>
                    <Link className='dashboard-link' href="/academic-officer/school-event" onClick={OnbodyClick}>
                      <div className="d-flex ps-5 py-2">
                        <p>School Event </p> 
                      </div>
                    </Link>
            ...
            <li className='mb-5 mx-3'>
              <Link href='/academic-officer/contact-us' className="site-btn px-3 Link"><i className="ri-phone-line pe-2"></i>Contact Support</Link>
            </li>
                ...
                <div className="dashboard-content-user-link cursor-pointer">
                  ...
                  {navDropdown &&
                    <div className="border-bottom-dark dashboard-content-user-drop-down  site-boxes">
                      <ul className=''>
                        <li className='pb-3'>
                          <Link href={`/academic-officer/user-profile/${authTokens?.user_id}`} className='light-link'>
                            <div className="d-flex">
...
export default AcademicOfficerFrame